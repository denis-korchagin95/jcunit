...
{
    struct ast_test * ast_test = memory_blob_pool_alloc(&memory_pool, sizeof(struct ast_test));
...
{
    struct ast_requirement * requirement = memory_blob_pool_alloc(&memory_pool, sizeof(struct ast_requirement));
